    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadBy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadBy_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadBy_Users_ReadById",
                        column: x => x.ReadById,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FriendDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadBy_MessageId",
                table: "ReadBy",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadBy_ReadById",
                table: "ReadBy",
                column: "ReadById");
